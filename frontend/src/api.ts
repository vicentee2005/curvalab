...
// En desarrollo el backend corre aparte, en localhost:8000. Desplegado en
// Vercel la API vive en el mismo origen (/api/...), servida por la función
// serverless de `api/index.py`, así que la base es la cadena vacía.
